<div class="w-7/12">
    @if ($this->taskByStatus->count() > 0)
        <livewire:tasks.tasks-count :$tasksByStatus="$this->taskByStatus"
                    ...
                    <div class="flex justify-between">
                        <div>
                            @foreach (App\Enums\StatusType::cases() as $case)
                                <button type="button"
                                    wire:click.live="changeStatus({{ $task->id }}, '{{ $case->value }}')"
                                    @class([
                        ...
                        <div>
                            ...
                            <x-primary-button wire:click="delete({{ $task }})"
